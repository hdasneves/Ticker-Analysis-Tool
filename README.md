This repository represents an application in which you can analyse a ticker or compare two tickers (graphs, return, volatility, KPI's...). You can also export the data into a csv file.
